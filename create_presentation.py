...
add_text_box(slide, Inches(0.8), Inches(0.4), Inches(11), Inches(0.6),
             "What AI Agents Can Do For Us", font_size=32, color=TEXT_WHITE, bold=True)
add_text_box(slide, Inches(0.8), Inches(1.0), Inches(11), Inches(0.4),
             "Everything in this demo was generated by Claude Code in a single session", font_size=14, color=TEXT_MUTED)

capabilities = [
    ("Mock Data", "10K realistic records\nwith risk correlations", ACCENT_LIGHT),
    ("Dashboard", "Interactive charts,\nheatmap & filters", CYAN),
    ("Predictor", "What-if premium\n& risk calculator", GREEN),
    ("Presentation", "Auto-generated slides\nwith charts & data", AMBER),
    ("PDF Report", "6-page actuarial\nreport with insights", ACCENT_LIGHT),
    ("Fraud Detection", "Score-based anomaly\ndetection system", ORANGE),
    ("Data Chatbot", "NL Q&A powered\nby Claude AI", PINK),
]
...
for i, (title, desc, color) in enumerate(capabilities):
    ...
    # Number badge
    badge = add_shape(slide, x + Inches(0.15), y + Inches(0.2), Inches(0.4), Inches(0.4), color)
    ...
    add_text_box(slide, x + Inches(0.15), y + Inches(0.8), w - Inches(0.3), Inches(0.3),
                 title, font_size=12, color=color, bold=True)
    add_text_box(slide, x + Inches(0.15), y + Inches(1.2), w - Inches(0.3), Inches(1.2),
                 desc, font_size=10, color=TEXT_MUTED)

# Bottom CTA
add_shape(slide, Inches(0.8), Inches(5.6), Inches(11.7), Inches(1.4), BG_SURFACE, BORDER)
add_text_box(slide, Inches(1.1), Inches(5.85), Inches(11), Inches(0.4),
             "Key Takeaway", font_size=16, color=ACCENT_LIGHT, bold=True)
add_text_box(slide, Inches(1.1), Inches(6.25), Inches(11), Inches(0.5),
             "AI coding agents don't replace developers \u2014 they amplify them. 7 deliverables built in a single session, from raw data to polished reports.",
